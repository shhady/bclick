...
export default function CategoryProducts({ category, products }) {
  ...
  return (
    <div>
      <div className="text-2xl pt-8 font-semibold cursor-pointer px-4" onClick={scrollToCategory}>
        {category.name}
      </div>
      <div ref={categoryRef} className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 mt-4 px-2">
