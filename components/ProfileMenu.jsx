  ...
  return (
    <div className='relative'>
      ...
      {openMenu && <div className='absolute top-10 left-0 w-[220px] bg-white shadow-md flex flex-col gap-3 p-2 text-gray-700'>
        <div className='p-3 border-b-2 flex justify-between items-center'><div>תצוגה מקדימה</div> <div><View color='#908E8E' size={18}/></div></div>
        <div className='p-3 flex justify-between items-center'><div>העתק קישור קטלוג</div> <div><Copy color='#908E8E' size={18}/></div></div>
        <div className='p-3 border-b-2 flex justify-between items-center'><div>שלח קישור לוואטסאפ</div> <div><MessageCircle color='#908E8E' size={18}/></div></div>
